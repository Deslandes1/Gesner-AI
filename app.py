...
# ---------- DEFAULT TRAINING (CLEAN, VERIFIED) ----------
def get_default_training_facts():
    ...
    facts.append("OU nan alfabè kreyòl la pwononse tankou 'ou' nan franse.")
    facts.append("UI nan alfabè kreyòl la pwononse tankou 'wi' nan kreyòl.")
    facts.append("NG nan alfabè kreyòl la pwononse tankou 'ng' nan 'sitting' an angle.")
